...
export type ReferralValidateSuccessData = {
...
export type ReferralValidateResponse<T> = {
...
export class ReferralService {
  ...
  /**
   * POST /api/partner/referral/validate
   * Kiểm tra tính hợp lệ của mã giới thiệu.
   * @param referralCode Mã giới thiệu (VD: "IA0888888888")
   * @returns ReferralValidateResponse<ReferralValidateSuccessData | null>
   */

  public async validateReferralCode(
    referralCode: string
  ): Promise<ReferralValidateResponse<ReferralValidateSuccessData | null>> {
