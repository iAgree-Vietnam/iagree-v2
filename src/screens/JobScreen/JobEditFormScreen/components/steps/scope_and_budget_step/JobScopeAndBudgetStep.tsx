...
function JobScopeAndBudgetStep(props: JobScopeAndBudgetStepsProps) {
  ...
  const jobDurationType = Form.useWatch("job_duration_type", form);
  ...
  const getCurrentTypeLabel = () => {
    const option = jobDurationTypeOptions.find(
      (opt) => opt.value === jobDurationType
    );
  ...
  return (
    <div className={"formGroupContainer"} style={{ borderBottom: "none" }}>
      <div className={"formGroupContentContainer"}>
          ...
          <Col xs={24} md={12}>
            ...
            >
              <Input.Group compact style={{ width: "100%" }}>
                <Form.Item name="job_duration_type" noStyle>
                  <Select
                    size="large"
            ...
            >
              <Radio.Group
                ...
                onChange={(e) => {
                  ...
                  form.setFieldsValue({ salaryType: val });
                }}
              />
            </Form.Item>
        ...
        {partnerId !== 0 && (
          <Form.Item name="is_public" label={null}>
            <Checkbox>
