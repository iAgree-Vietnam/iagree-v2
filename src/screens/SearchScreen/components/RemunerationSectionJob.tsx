...
type RemunerationSectionJobProps = {
  filters: Partial<JobsFilterParamsV2>;
  setFilters: React.Dispatch<React.SetStateAction<JobsFilterParamsV2>>;
  setDefaultJobPageWhenFilter: () => void;
  dotColor: string;
};

const RemunerationSectionJob = ({
  filters,
  setFilters,
  setDefaultJobPageWhenFilter,
  dotColor,
}: RemunerationSectionJobProps) => {
  ...
  const handlePriceRangeChange = useCallback(
    ...
    [setFilters, setDefaultJobPageWhenFilter, localPriceMin, localPriceMax]
  );
...
export default RemunerationSectionJob;
