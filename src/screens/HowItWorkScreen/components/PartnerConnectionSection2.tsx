...
import styles from "./PartnerConnectionSection2.module.css";
...
const partnerSteps = [
  {
    ...
    description: "Chỉ với vài bước để hoàn tất <br/> đăng ký tài khoản trên iAgree.",
    image: "/assets/img/how-it-work/bg_1.png",
  },
  {
    id: 2,
    number: "02",
    title: "Lựa chọn Đối tác <br/> phù hợp",
    description: "Tìm kiếm và lựa chọn Đối tác dự <br/> trên kỹ năng và lĩnh vực chuyên môn.",
    image: "/assets/img/how-it-work/bg_2.png",
  },
  {
    id: 3,
    number: "03",
    title: "Gửi lời mời",
    description: "Chủ động mời cộng tác <br/> chỉ với một cú click.",
    image: "/assets/img/how-it-work/bg_3.png",
  },
  {
    id: 4,
    number: "04",
    title: "Thống nhất công việc",
    description: "Thống nhất công việc sau khi <br/> thỏa thuận rõ ràng với nhau.",
  ...
  },
  {
    ...
    description: "Thanh toán 100% số tiền và ủy quyền <br/> cho iAgree tạm giữ cho đến khi<br/> hoàn tất công việc",
  ...
  },
  {
    ...
    description: "Cập nhật và phản hồi trong <br/> quá trình thực hiện công việc.",
  ...
  },
  {
    ...
    number: "07",
    title: "Nghiệm thu",
    description: "Kiểm tra sản phẩm, xác nhận <br/> kết quả trước khi giải ngân.",
...
const PartnerConnectionSection2: React.FC = () => {
            ...
            {isMobile ? (
              <>
                <div className={styles.introRight}>
                  {isMobile ? "Hình thức 2" : "Hình thức 2----------"}
                </div>
                <div className={styles.introLeft}>
                  Chủ động tìm kiếm Đối tác <br />
                  theo yêu cầu
                </div>
              </>
            ) : (
              <>
                ...
                <div className={styles.introRight}>Hình thức 2----------</div>
              </>
            )}
          </div>
...
export default PartnerConnectionSection2;