          ...
          >
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_INFO ? "active" : null
              }`}
            >
              {/* <JobInfo
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_PARTNER ? "active" : null
              }`}
            >
              <JobPartner
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_PAYMENT ||
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_SIGN ? "active" : null
              }`}
            >
              <JobSign
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_REPORT ? "active" : null
              }`}
            >
              <JobReport
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_REVIEW ? "active" : null
              }`}
            >
              <JobReview
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_RATE ? "active" : null
              }`}
            >
              <JobRate
                jobQuery={jobQuery}
            ...
            <div
              className={`jobStepContainer ${
                stepName === Constants.JOB.TAB.JOB_RESULT ? "active" : null
              }`}
            >
              <JobResult
                jobQuery={jobQuery}
