    ...
    return function PDFViewerComponent({
      ...
      return (
        ...
        >
          ...
          <iframe
            src={`${baseUrl}/policy/policy-for-partner.html`}
            style={{
              width: "100%",
              height: "100%",
...
interface TermForPartnerModalProps {
    visible: boolean;
    onClose: () => void;
    onAccept: () => void;
}

const TermForPartnerModal: React.FC<TermForPartnerModalProps> = ({
    visible,
    onClose,
    onAccept,
}) => {
    ...
    const baseUrl = process.env.BASE_URL;
    const pdfLink = `${baseUrl}/policy/policy-for-partner.html`;
...
export default TermForPartnerModal;