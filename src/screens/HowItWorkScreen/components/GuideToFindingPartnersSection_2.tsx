// GuideToFindingPartnersSection_2.tsx
"use client";

import React, { useEffect, useRef, useState } from "react";
import { Button } from "antd";
import styles from "./GuideToFindingPartnersSection_2.module.css";
...
const videoUrl =
  "https://demo.arcade.software/3aXQDpwwtDU0An0g2lmr?embed&embed_mobile=inline&embed_desktop=inline&show_copy_link=true";

const GuideToFindingPartnersSection_2: React.FC = () => {
  ...
  const handleNextClick = () => {
    const nextSection = document.getElementById("guide-to-finding-partners-3");
    if (nextSection) {
      const sectionTop =
  ...
  return (
    <Fade direction="right" cascade damping={0.1} triggerOnce={true}>
      <section
        id="guide-to-finding-partners-2"
        className={styles.guideContainer}
      >
        <div className={styles.guideFlexContainer}>
          {/* Text Content - Left Side */}
          <div className={styles.textContent}>
            <div className={styles.mainTitle}>2. Phạm vi & Ngân sách</div>
            <div className={styles.subTitle}>
              Đưa ra ngân sách và thời hạn cho công việc. Bạn có thể thỏa thuận
              thêm với Freelancer sau khi được kết nối.
            </div>
            <Button
              type="primary"
              size="large"
          ...
          <div className={styles.videoContent}>
            ...
            <VideoThumbnail
              ...
              thumbnail="/assets/img/introduce/thumb_pham_vi.png"
            />
          </div>
        </div>
      </section>
...
export default GuideToFindingPartnersSection_2;
